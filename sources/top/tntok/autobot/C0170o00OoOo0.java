...
public class C0170o00OoOo0 extends iilLiIIIi11i implements Serializable {
    private static final long serialVersionUID = -547733176983104172L;
    private final long byteOffset;
    private final byte[] magicNumbers;

    public C0170o00OoOo0(byte[] bArr) {
        this(bArr, 0);
    }
    ...
    public boolean accept(java.io.File r6) {
        ...
        L_0x0041:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: top.tntok.autobot.C0170o00OoOo0.accept(java.io.File):boolean");
    }
    ...
    public C0170o00OoOo0(String str) {
        this(str, 0);
    }

    public C0170o00OoOo0(String str, long j) {
        if (str == null) {
    ...
    public C0170o00OoOo0(byte[] bArr, long j) {
        if (bArr == null) {
            throw new IllegalArgumentException("The magic number cannot be null");
